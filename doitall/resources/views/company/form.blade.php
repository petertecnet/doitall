	...
	<option value="DF"  @if (!empty($cad)) {{ $cad->uf == 'DF' ? 'selected' : '' }} @endif >Distrito Federal</option>
	<option value="ES"  @if (!empty($cad)) {{ $cad->uf == 'ES' ? 'selected' : '' }} @endif >Espírito Santo</option>
	...
	<option value="MS"  @if (!empty($cad)) {{ $cad->uf == 'MS' ? 'selected' : '' }} @endif >Mato Grosso do Sul</option>
	...
	<option value="RJ"  @if (!empty($cad)) {{ $cad->uf == 'RJ' ? 'selected' : '' }} @endif >Rio de Janeiro</option>
	<option value="RN"  @if (!empty($cad)) {{ $cad->uf == 'RN' ? 'selected' : '' }} @endif >Rio Grande do Norte</option>
	<option value="RS"  @if (!empty($cad)) {{ $cad->uf == 'RS' ? 'selected' : '' }} @endif >Rio Grande do Sul</option>
	...
	<option value="SC"  @if (!empty($cad)) {{ $cad->uf == 'SC' ? 'selected' : '' }} @endif >Santa Catarina</option>
